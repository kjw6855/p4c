...
#ifndef BACKENDS_GRAPHS_DEF_USE_H_
#define BACKENDS_GRAPHS_DEF_USE_H_
...
class ComputeDefUse : public Inspector,
 ...
 public:
    ComputeDefUse(std::vector<Graph *> &cga);
    void clear();
...
namespace std {
template <>
struct hash<P4::graphs::ComputeDefUse::loc_t> {
    std::size_t operator()(const P4::graphs::ComputeDefUse::loc_t &loc) const { return loc.hash(); }
};

}  // namespace std

#endif /* BACKENDS_GRAPHS_DEF_USE_H_ */
