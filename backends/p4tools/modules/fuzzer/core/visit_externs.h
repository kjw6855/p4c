#ifndef BACKENDS_P4TOOLS_MODULES_FUZZER_CORE_VISIT_EXTERNS_H_
#define BACKENDS_P4TOOLS_MODULES_FUZZER_CORE_VISIT_EXTERNS_H_
...
class VisitExternMethodImpls {
 public:
    ...
    bool exec(const IR::MethodCallExpression* call, const IR::Expression* receiver, IR::ID& name,
              ...
              VisitStepEvaluator::VisitResult& result) const;
    ...
    using MethodImpl = std::function<void(const IR::MethodCallExpression*, const IR::Expression*,
                                          ...
                                          const VisitState&, VisitStepEvaluator::VisitResult&)>;
 ...
 public:
    ...
    explicit VisitExternMethodImpls(const ImplList& implList);
};
...
#endif /* BACKENDS_P4TOOLS_MODULES_FUZZER_CORE_VISIT_EXTERNS_H_ */
