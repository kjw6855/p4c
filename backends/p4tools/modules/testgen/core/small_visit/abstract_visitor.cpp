...
bool AbstractVisitor::stepGetHeaderValidity(const IR::StateVariable &headerRef) {
...
void AbstractVisitor::setHeaderValidity(const IR::StateVariable &headerRef, bool validity,
...
bool AbstractVisitor::stepSetHeaderValidity(const IR::StateVariable &headerRef, bool validity) {
...
void AbstractVisitor::declareStructLike(ExecutionState &nextState,
