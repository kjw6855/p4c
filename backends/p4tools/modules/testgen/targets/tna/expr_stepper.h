#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_EXPR_STEPPER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_EXPR_STEPPER_H_
...
class TnaExprStepper : public ExprStepper {
 protected:
 ...
 public:
    TnaExprStepper(ExecutionState &state, AbstractSolver &solver,
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_EXPR_STEPPER_H_ */
