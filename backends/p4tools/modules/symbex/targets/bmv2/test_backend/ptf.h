#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_BMV2_TEST_BACKEND_PTF_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_BMV2_TEST_BACKEND_PTF_H_
...
class PTF : public Bmv2TestFramework {
 ...
 private:
    ...
    /// @returns the inja template for a three-phase tampering test class.
...
#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_BMV2_TEST_BACKEND_PTF_H_ */
