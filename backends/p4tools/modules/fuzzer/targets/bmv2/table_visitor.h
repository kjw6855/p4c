#ifndef BACKENDS_P4TOOLS_MODULES_FUZZER_TARGETS_BMV2_TABLE_VISITOR_H_
#define BACKENDS_P4TOOLS_MODULES_FUZZER_TARGETS_BMV2_TABLE_VISITOR_H_
...
class BMv2_V1ModelTableVisitor : public TableVisitor {
 private:
 ...
 protected:
    const IR::Expression* computeTargetMatchType(VisitState* nextState,
 ...
 public:
    explicit BMv2_V1ModelTableVisitor(BMv2_V1ModelVisitStepper* stepper, const IR::P4Table* table, const TestCase& testCase);
};
...
#endif /* BACKENDS_P4TOOLS_MODULES_FUZZER_TARGETS_BMV2_TABLE_VISITOR_H_ */
