    ...
    for file in files:
        ...
        if produced.endswith(".spec") and environ.get("DPDK_PIPELINE") is not None:
            ...
            with open(clifile, "w", encoding="utf-8") as f:
                ...
                f.write("\n")
                f.write(
                    "link LINK0 dev 0000:00:04.0 rxq 1 128 MEMPOOL0 txq 1 512 promiscuous on\n"
                )
                f.write(
                    "link LINK1 dev 0000:00:05.0 rxq 1 128 MEMPOOL0 txq 1 512 promiscuous on\n"
                )
                f.write(
                    "link LINK2 dev 0000:00:06.0 rxq 1 128 MEMPOOL0 txq 1 512 promiscuous on\n"
                )
                f.write(
                    "link LINK3 dev 0000:00:07.0 rxq 1 128 MEMPOOL0 txq 1 512 promiscuous on\n"
                )
                f.write("\n")
