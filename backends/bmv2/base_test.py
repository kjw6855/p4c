...
class P4RuntimeTest(BaseTest):
    ...
    def handshake(self):
        ...
        logging.debug(
            "handshake() checking whether arbitration msg received from server"
        )
    ...
    def push_update_add_entry_to_action(
        self, req, t_name, mk, a_name, params, priority=None
    ):
        update = req.updates.add()
        update.type = p4runtime_pb2.Update.INSERT
    ...
    def send_request_add_entry_to_action(
        self, t_name, mk, a_name, params, priority=None
    ):
        req = p4runtime_pb2.WriteRequest()
        req.device_id = self.device_id
