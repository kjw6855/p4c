#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TEST_BACKEND_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TEST_BACKEND_H_
...
class TnaTestBackend : public TestBackEnd {
 private:
    /// These three constants are used for a special case. When the output packet is 0 in TNA, the
 ...
 public:
    explicit TnaTestBackend(const ProgramInfo &programInfo, SymbolicExecutor &symbex,
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TEST_BACKEND_H_ */
