...
bool VisitExternMethodImpls::exec(const IR::MethodCallExpression* call, const IR::Expression* receiver,
...
bool VisitExternMethodImpls::matches(const std::vector<cstring>& paramNames,
...
VisitExternMethodImpls::VisitExternMethodImpls(const ImplList& inputImplList) {
