#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_VISIT_CONCOLIC_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_VISIT_CONCOLIC_H_
...
class VisitConcolicResolver : public Inspector {
 public:
    explicit VisitConcolicResolver(const Model &completedModel, const ExecutionState &state,
                              const ConcolicMethodImpls &concolicMethodImpls);

    VisitConcolicResolver(const Model &completedModel, const ExecutionState &state,
                     const ConcolicMethodImpls &concolicMethodImpls,
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_VISIT_CONCOLIC_H_ */
