#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_CONCOLIC_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_CONCOLIC_H_
...
class TnaConcolic : public Concolic {
 private:
    ...
    static const ConcolicMethodImpls::ImplList TNA_CONCOLIC_METHOD_IMPLS;
 ...
 public:
    ...
    static const ConcolicMethodImpls::ImplList *getTnaConcolicMethodImpls();
};

}  // namespace P4Tools::P4Testgen::Tna

#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_CONCOLIC_H_ */
