#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_TEST_GTEST_UTILS_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_TEST_GTEST_UTILS_H_
...
class SymbexTest : public testing::Test {
 public:
    [[nodiscard]] static std::unique_ptr<AutoCompileContext> SetUp(std::string_view target,
        ...
        /// Set up the appropriate compile context for Symbex tests.
        /// TODO: Remove this once options are not initialized statically anymore.
        auto ctxOpt = Symbex::SymbexTarget::initializeTarget(P4::P4Tools::Symbex::TOOL_NAME,
                                                                 target, archName);
...
#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_TEST_GTEST_UTILS_H_ */
