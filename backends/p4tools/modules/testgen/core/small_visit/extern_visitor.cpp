...
#include "backends/p4tools/modules/testgen/core/small_visit/expr_visitor.h"  // IWYU pragma: associated
...
void ExprVisitor::evalInternalExternMethodCall(const IR::MethodCallExpression *call,
...
void ExprVisitor::evalExternMethodCall(const IR::MethodCallExpression *call,
                                       const IR::Expression *receiver, IR::ID name,
                                       const IR::Vector<IR::Argument> *args,
