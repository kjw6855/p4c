#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_BMV2_EXPR_PARSE_GETTER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_BMV2_EXPR_PARSE_GETTER_H_
...
class Bmv2V1ModelExprParseGetter : public ExprParseGetter {
 protected:
 ...
 private:
    ...
    void processClone(const ExecutionState &state, SmallParseGetEvaluator::Result &result);

    /// Helper function, which is triggered when resubmit or recirculate was called in the P4
    /// program.
    void processRecirculate(const ExecutionState &state, SmallParseGetEvaluator::Result &result);

 public:
    Bmv2V1ModelExprParseGetter(ExecutionState &state,
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_BMV2_EXPR_PARSE_GETTER_H_ */
