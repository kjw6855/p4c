#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_VISIT_TABLE_STEPPER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_VISIT_TABLE_STEPPER_H_
...
class TableVisitor {
 protected:
    /// Reference to the calling expression visitor.
    ExprVisitor *visitor;
 ...
 protected:
    ...
    /// @returns the result pointer of the friend class ExpressionVisitor.
    ExprVisitor::Result getResult();
    ...
    /// match or does not match at all. The table visitor first checks these custom match types. If
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_VISIT_TABLE_STEPPER_H_ */
