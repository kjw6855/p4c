#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_EXPLORATION_STRATEGY_SELECTED_TEST_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_EXPLORATION_STRATEGY_SELECTED_TEST_H_
...
class SelectedTest : public ExplorationStrategy {
 public:
    ...
    SelectedTest(AbstractSolver& solver, const ProgramInfo& programInfo,
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_EXPLORATION_STRATEGY_SELECTED_TEST_H_ */
