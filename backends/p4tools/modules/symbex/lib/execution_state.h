#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_LIB_EXECUTION_STATE_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_LIB_EXECUTION_STATE_H_
...
#include "backends/p4tools/modules/symbex/lib/graphs/graphs.h"
#include "backends/p4tools/modules/symbex/lib/graphs/controls.h"
#include "backends/p4tools/modules/symbex/lib/graphs/parsers.h"
...
class ExecutionState : public AbstractExecutionState {
 ...
 public:
    ...
    [[nodiscard]] const std::list<cstring> &getVisitedParserStates() const;
    [[nodiscard]] const std::map<cstring, big_int> &getVisitedPaths() const;
    [[nodiscard]] const std::list<cstring> &getVisitedPathComponents() const;
...
#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_LIB_EXECUTION_STATE_H_ */
