#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_BMV2_CMD_PARSE_GETTER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_BMV2_CMD_PARSE_GETTER_H_
...
class Bmv2V1ModelCmdParseGetter : public CmdParseGetter {
 protected:
    std::string getClassName() override { return "Bmv2V1ModelCmdParseGetter"; }
 ...
 public:
    Bmv2V1ModelCmdParseGetter(ExecutionState &nextState,
                          const ProgramInfo &programInfo);
};

}  // namespace P4Tools::P4Testgen::Bmv2

#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_BMV2_CMD_PARSE_GETTER_H_ */
