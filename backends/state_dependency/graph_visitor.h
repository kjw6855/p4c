...
#ifndef BACKENDS_STATE_DEPENDENCY_GRAPH_VISITOR_H_
#define BACKENDS_STATE_DEPENDENCY_GRAPH_VISITOR_H_
...
class GraphVisitor : public Graphs, public Inspector {
 private:
 ...
 public:
    ...
    const char *getType(const VertexFlags &v_flags);
    ...
    /// main function
    ///
    /// based on the value of boolean class variables "graphs", "fullGraph", "jsonOut"
    /// executes:
 ...
 private:
    ...
    /// Loops over vector graphsArray with boost graphs, creating fullgraph
...
#endif /* BACKENDS_STATE_DEPENDENCY_GRAPH_VISITOR_H_ */
