#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TABLE_STEPPER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TABLE_STEPPER_H_
...
class TnaTableStepper : public TableStepper {
 private:
 ...
 public:
    explicit TnaTableStepper(TnaExprStepper *stepper, const IR::P4Table *table);
};

}  // namespace P4Tools::P4Testgen::Tna

#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TABLE_STEPPER_H_ */
