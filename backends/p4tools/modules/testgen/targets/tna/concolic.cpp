...
#include "backends/p4tools/modules/testgen/targets/tna/contrib/tna_hash/calculations.h"

namespace P4Tools::P4Testgen::Tna {

std::vector<char> TnaConcolic::convertBigIntToBytes(big_int &dataInt, int targetWidthBits) {
...
big_int TnaConcolic::computeChecksum(const std::vector<const IR::Expression *> &exprList,
    ...
    switch (algo) {
        case TnaHashAlgorithm::csum16: {
            checksumFun = TNAHash::csum16;
            break;
        }
        case TnaHashAlgorithm::crc32: {
            checksumFun = TNAHash::crc32;
            break;
        }
        case TnaHashAlgorithm::crc16: {
            checksumFun = TNAHash::crc16;
            break;
        }
        case TnaHashAlgorithm::identity: {
            checksumFun = TNAHash::identity;
            break;
        }
        case TnaHashAlgorithm::xor16: {
            checksumFun = TNAHash::xor16;
            break;
        }
        case TnaHashAlgorithm::random: {
            BUG("Random should not be encountered here");
        }
        case TnaHashAlgorithm::crc32_custom:
        case TnaHashAlgorithm::crc16_custom:
        default:
...
const ConcolicMethodImpls::ImplList TnaConcolic::TNA_CONCOLIC_METHOD_IMPLS{
    /* ======================================================================================
     *   method_hash
     * ====================================================================================== */
...
const ConcolicMethodImpls::ImplList *TnaConcolic::getTnaConcolicMethodImpls() {
    return &TNA_CONCOLIC_METHOD_IMPLS;
}
