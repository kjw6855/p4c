#ifndef BACKENDS_P4TOOLS_MODULES_FUZZER_LIB_FINAL_VISIT_STATE_H_
#define BACKENDS_P4TOOLS_MODULES_FUZZER_LIB_FINAL_VISIT_STATE_H_
...
class FinalVisitState {
 ...
 public:
    FinalVisitState(const VisitState& inputState);
    ...
    static Model completeModel(const VisitState& visitState);
    ...
    const VisitState* getVisitState() const;
...
#endif /* BACKENDS_P4TOOLS_MODULES_FUZZER_LIB_FINAL_VISIT_STATE_H_ */
