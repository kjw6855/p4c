...
#include "backends/p4tools/modules/testgen/core/small_parse_get/expr_parse_getter.h"  // IWYU pragma: associated
...
std::vector<std::pair<IR::StateVariable, const IR::Expression *>> ExprParseGetter::setFields(
...
ExprParseGetter::PacketCursorAdvanceInfo ExprParseGetter::calculateSuccessfulParserAdvance(
...
ExprParseGetter::PacketCursorAdvanceInfo ExprParseGetter::calculateAdvanceExpression(
...
void ExprParseGetter::evalInternalExternMethodCall(const IR::MethodCallExpression *call,
...
void ExprParseGetter::evalExternMethodCall(const IR::MethodCallExpression *call,
                                       const IR::Expression *receiver, IR::ID name,
                                       const IR::Vector<IR::Argument> *args,
        ...
        {"packet_in.advance",
         ...
         [this](const IR::MethodCallExpression *call, const IR::Expression * /*receiver*/,
             ...
             if (!SymbolicEnv::isSymbolicValue(advanceExpr)) {
                 parseGetToSubexpr(advanceExpr, result, state,
        ...
        {"packet_in.extract",
         ...
         [this](const IR::MethodCallExpression *call, const IR::Expression * /*receiver*/,
             ...
             if (!SymbolicEnv::isSymbolicValue(varbitExtractExpr)) {
                 parseGetToSubexpr(varbitExtractExpr, result, state,
                               [call](const Continuation::Parameter *v) {
                                   auto *clonedCall = call->clone();
                                   auto *arguments = clonedCall->arguments->clone();
