...
set(SYMBEX_PNA_P416_TESTS "${CMAKE_CURRENT_LIST_DIR}/p4-programs/*.p4")
p4c_find_tests("${SYMBEX_PNA_P416_TESTS}" CUSTOM_PNA_TESTS INCLUDE "${PNA_SEARCH_PATTERNS}" EXCLUDE "")

# Add PNA tests from P4C and from symbex/test/p4-programs/pna
...
# TEST SUITES
#############################################################################
option(P4TOOLS_SYMBEX_PNA_TEST_METADATA "Run tests on the Metadata test back end" ON)
option(P4TOOLS_SYMBEX_PNA_TEST_PTF "Run tests on the PTF test back end" ON)

# Test settings.
set(EXTRA_OPTS "--strict --print-traces --seed 1000 --max-tests 10 ")

# Metadata
if(P4TOOLS_SYMBEX_PNA_TEST_METADATA)
  p4tools_add_tests(
    TESTS "${PNA_TEST_SUITE}"
    TAG "symbex-p4c-pna-metadata" DRIVER ${SYMBEX_DRIVER}
...
if(P4TOOLS_SYMBEX_PNA_TEST_PTF AND INFRAP4D AND EXISTS ${IPDK_INSTALL_DIR})
  ...
  p4tools_add_tests(
          ...
          TAG "symbex-p4c-pna-ptf" DRIVER ${SYMBEX_DRIVER}
