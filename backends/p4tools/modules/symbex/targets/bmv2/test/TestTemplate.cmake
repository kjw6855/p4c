...
function(validate_protobuf testfile testfolder)
  ...
  file(
    APPEND ${testfile}
    "\t${Protobuf_PROTOC_EXECUTABLE} --proto_path ${Protobuf_INCLUDE_DIRS} --proto_path ${CMAKE_CURRENT_LIST_DIR}/../proto --proto_path ${P4RUNTIME_STD_DIR} --proto_path ${P4C_SOURCE_DIR}/control-plane --encode=symbex.TestCase symbex.proto < \${item} > /dev/null\n"
  )
  file(APPEND ${testfile} "done\n")
...
function(validate_protobuf_ir testfile testfolder)
  ...
  file(
    APPEND ${testfile}
    "\t${Protobuf_PROTOC_EXECUTABLE} --proto_path ${Protobuf_INCLUDE_DIRS} --proto_path ${CMAKE_CURRENT_LIST_DIR}/../proto --proto_path ${P4RUNTIME_STD_DIR} --proto_path ${P4C_SOURCE_DIR} --proto_path ${P4C_SOURCE_DIR}/control-plane --encode=symbex_ir.TestCase symbex_ir.proto < \${item} > /dev/null\n"
  )
  file(APPEND ${testfile} "done\n")
...
function(p4tools_add_test_with_args)
  ...
  set(__testfile "${SYMBEX_DIR}/${tag}/${alias}.test")
  set(__testfolder "${SYMBEX_DIR}/${tag}/${aliasname}.out")
