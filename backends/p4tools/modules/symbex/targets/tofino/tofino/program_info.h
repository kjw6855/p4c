...
#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_TOFINO_TOFINO_PROGRAM_INFO_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_TOFINO_TOFINO_PROGRAM_INFO_H_
...
class TofinoProgramInfo : public TofinoSharedProgramInfo {
 private:
 ...
 public:
    TofinoProgramInfo(const TofinoCompilerResult &compilerResult, std::vector<PipeInfo> inputPipes,
    ...
    DECLARE_TYPEINFO(TofinoProgramInfo, TofinoSharedProgramInfo);
};

}  // namespace P4::P4Tools::Symbex::Tofino

#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_TOFINO_TOFINO_PROGRAM_INFO_H_ */
