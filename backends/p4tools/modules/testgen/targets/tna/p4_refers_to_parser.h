#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_P4_REFERS_TO_PARSER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_P4_REFERS_TO_PARSER_H_
...
class TnaRefersToParser : public Inspector {
 ...
 public:
    explicit TnaRefersToParser(std::vector<std::vector<const IR::Expression *>> &output);
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_P4_REFERS_TO_PARSER_H_ */
