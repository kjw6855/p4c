#ifndef BACKENDS_P4TOOLS_MODULES_FUZZER_CORE_SMALL_STEP_TABLE_VISITOR_H_
#define BACKENDS_P4TOOLS_MODULES_FUZZER_CORE_SMALL_STEP_TABLE_VISITOR_H_
...
class TableVisitor {
 ...
 protected:
    ...
    VisitStepper::VisitResult getResult();
    ...
    void setTableAction(VisitState* nextState, const IR::MethodCallExpression* actionCall);
...
#endif /* BACKENDS_P4TOOLS_MODULES_FUZZER_CORE_SMALL_STEP_TABLE_VISITOR_H_ */
