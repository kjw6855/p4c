...
class Ipv4SetVersionTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="0 0 0 0 5 0 0 0 0 0 0 0"
        )
...
class Ipv4SetIhlTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="1 0 0 0 15 0 0 0 0 0 0 0"
        )
...
class Ipv4SetDiffservTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="2 0 0 0 255 0 0 0 0 0 0 0"
        )
...
class Ipv4SetIdentificationTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="3 0 0 0 211 0 0 0 0 0 0 0"
        )
...
class Ipv4SetFlagsTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="4 0 0 0 7 0 0 0 0 0 0 0"
        )
...
class Ipv4SetFragOffsetTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="5 0 0 0 13 0 0 0 0 0 0 0"
        )
...
class Ipv4SetTtlTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="6 0 0 0 60 0 0 0 0 0 0 0"
        )
...
class Ipv4SetProtocolTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="7 0 0 0 55 0 0 0 0 0 0 0"
        )
...
class Ipv4SetSrcTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="8 0 0 0 2 2 168 192 0 0 0 0"
        )
...
class Ipv4SetDstTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="9 0 0 0 2 2 168 192 0 0 0 0"
        )
...
class Ipv4SetSrcDstTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="10 0 0 0 10 10 10 10 10 10 10 10"
        )
...
class Ipv4SetIhlDiffservTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="11 0 0 0 15 26 0 0 0 0 0 0"
        )
...
class Ipv4SetFragmentOffsetFlagTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="12 0 0 0 13 0 7 0 0 0 0 0"
        )

    def runTest(self):
        pkt = Ether() / IP(src="192.168.1.1", frag=0, flags=0) / TCP() / "Ala ma kota"
        exp_pkt = (
            Ether() / IP(src="192.168.1.1", frag=13, flags=7) / TCP() / "Ala ma kota"
        )
...
class Ipv4SetFlagsTtlTest(Ipv4Test):
    def setUp(self):
        ...
        self.update_bpf_map(
            map_id=0, key="1 1 168 192", value="13 0 0 0 7 50 0 0 0 0 0 0"
        )

    def runTest(self):
        pkt = Ether() / IP(src="192.168.1.1", flags=0, ttl=64) / TCP() / "Ala ma kota"
        exp_pkt = (
            Ether() / IP(src="192.168.1.1", flags=7, ttl=50) / TCP() / "Ala ma kota"
        )
