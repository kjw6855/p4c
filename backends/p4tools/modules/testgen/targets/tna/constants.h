#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_CONSTANTS_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_CONSTANTS_H_

#include <cstdint>

namespace P4Tools::P4Testgen::Tna {

enum tna_gress_t { TNA_INGRESS, TNA_EGRESS };
...
class TNAConstants {
 public:
    ...
    static constexpr int STF_MIN_PKT_SIZE = 64;
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_CONSTANTS_H_ */
