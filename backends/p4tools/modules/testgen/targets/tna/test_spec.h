#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TEST_SPEC_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TEST_SPEC_H_
...
class TnaRegisterValue : public IndexMap {
 public:
    explicit TnaRegisterValue(const IR::Expression *initialValue);

    [[nodiscard]] cstring getObjectName() const override;

    [[nodiscard]] const TnaRegisterValue *evaluate(const Model &model) const override;
};
...
class TnaMeterValue : public IndexMap {
 private:
    /// Whether the meter is a direct meter.
    bool isDirect;

 public:
    explicit TnaMeterValue(const IR::Expression *initialValue, bool isDirect);

    [[nodiscard]] cstring getObjectName() const override;

    [[nodiscard]] const TnaMeterValue *evaluate(const Model &model) const override;
 ...
 *  TnaActionProfile
 * ========================================================================================= */
class TnaActionProfile : public TestObject {
 private:
 ...
 public:
    explicit TnaActionProfile(const IR::IDeclaration *profileDecl);
    ...
    [[nodiscard]] const TnaActionProfile *evaluate(const Model &model) const override;
};

/* =========================================================================================
 *  ActionSelector
 * ========================================================================================= */
class TnaActionSelector : public TestObject {
 private:
 ...
 public:
    explicit TnaActionSelector(const IR::IDeclaration *selectorDecl,
                                       const TnaActionProfile *actionProfile);
    ...
    [[nodiscard]] const TnaActionProfile *getActionProfile() const;

    [[nodiscard]] const TnaActionSelector *evaluate(const Model &model) const override;
};

/* =========================================================================================
 *  TnaCloneInfo
 * ========================================================================================= */
class TnaCloneInfo : public TestObject {
 private:
 ...
 public:
    explicit TnaCloneInfo(const IR::Expression *sessionId,
                                  TNAConstants::CloneType cloneType,
    ...
    [[nodiscard]] const TnaCloneInfo *evaluate(const Model &model) const override;
    ...
    [[nodiscard]] TNAConstants::CloneType getCloneType() const;
 ...
 *  TnaCloneSpec
 * ========================================================================================= */
class TnaCloneSpec : public TestObject {
 private:
    /// The session ID associated with this clone information.
    const IR::Expression *sessionId;
 ...
 public:
    explicit TnaCloneSpec(const IR::Expression *sessionId, const IR::Expression *clonePort,
                                  bool isClone);

    [[nodiscard]] cstring getObjectName() const override;

    [[nodiscard]] const TnaCloneSpec *evaluate(const Model &model) const override;
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_TEST_SPEC_H_ */
