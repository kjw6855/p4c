#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_PROGRAM_INFO_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_PROGRAM_INFO_H_
...
class TnaProgramInfo : public ProgramInfo {
 private:
 ...
 public:
    TnaProgramInfo(const IR::P4Program *program,
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_TNA_PROGRAM_INFO_H_ */
