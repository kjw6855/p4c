...
set(
  P4TOOLS_SYMBEX_TOFINO_EXCLUDES
...
set(
  P4TOOLS_SYMBEX_TOFINO_DUPLICATES
  ${TOFINO_SOURCE_DIR}/p4-tests/p4_16/stf/match_key_slices.p4
)
list(REMOVE_ITEM P4TOOLS_SYMBEX_TOFINO ${P4TOOLS_SYMBEX_TOFINO_DUPLICATES} ${P4TOOLS_SYMBEX_TOFINO_EXCLUDES})

set(TNA_SEARCH_PATTERNS "include.*tna.p4" "main")
p4c_find_tests("${P4TOOLS_SYMBEX_TOFINO}" P4TOOLS_SYMBEX_TOFINO_TNA INCLUDE "${TNA_SEARCH_PATTERNS}" EXCLUDE "${P4TOOLS_SYMBEX_TOFINO_EXCLUDES}")

# Custom tests, not subject to deduplication.
file(
  GLOB
  P4TOOLS_SYMBEX_TOFINO_CUSTOM
...
set(
  P4TOOLS_SYMBEX_TOFINO_TNA
  ${P4TOOLS_SYMBEX_TOFINO_TNA}
  ${P4TOOLS_SYMBEX_TOFINO_CUSTOM}
)

set(T2NA_SEARCH_PATTERNS "include.*t2na.p4" "main")
p4c_find_tests("${P4TOOLS_SYMBEX_TOFINO}" P4TOOLS_SYMBEX_TOFINO_T2NA INCLUDE "${T2NA_SEARCH_PATTERNS}" EXCLUDE "${P4TOOLS_SYMBEX_TOFINO_EXCLUDES}")

# Custom tests, not subject to deduplication.
file(
  GLOB
  P4TOOLS_SYMBEX_TOFINO_T2NA_CUSTOM
  ${CMAKE_CURRENT_LIST_DIR}/p4-programs/*.p4
  ${CMAKE_CURRENT_LIST_DIR}/p4-programs/tna_simple_switch/tna_simple_switch.p4
...
# # # ##########################################################################
set(
  P4TOOLS_SYMBEX_TOFINO_INC_PATH
  ${TOFINO_SOURCE_DIR}/p4-tests/p4-programs/p4_16_programs/
)
set(
  P4TOOLS_SYMBEX_TOFINO_P416_INC_PATH
  ${TOFINO_SOURCE_DIR}/p4-tests/p4_16/includes
)

set(
  P4TOOLS_SYMBEX_TOFINO_INTERNAL_TESTS_INC_PATH
  ${TOFINO_SOURCE_DIR}/p4-tests/p4_16/stf/include/
)
set(
  P4TOOLS_SYMBEX_TOFINO_SWITCH_INC_PATH
  ${TOFINO_SOURCE_DIR}/p4-tests/p4_16/switch_16/p4src/shared
)

# Test settings.
set(P416INCLUDES "-I${P4C_SOURCE_DIR}/backends/tofino/bf-p4c/p4include -I${P4C_SOURCE_DIR}/p4include -I${P4TOOLS_SYMBEX_TOFINO_INC_PATH} -I${P4TOOLS_SYMBEX_TOFINO_P416_INC_PATH} -I${P4TOOLS_SYMBEX_TOFINO_INTERNAL_TESTS_INC_PATH} -I${P4TOOLS_SYMBEX_TOFINO_SWITCH_INC_PATH}")
if(NOT NIGHTLY)
...
p4tools_add_tests(
  ...
  TAG "symbex-tofino" DRIVER ${SYMBEX_DRIVER}
...
set (P4TOOLS_SYMBEX_TOFINO_T2NA_STF ${P4TOOLS_SYMBEX_TOFINO_T2NA})
list(REMOVE_ITEM P4TOOLS_SYMBEX_TOFINO_T2NA_STF
  # This test times out when running on STF.
)
p4tools_add_tests(
  TESTS "${P4TOOLS_SYMBEX_TOFINO_T2NA_STF}"
  TAG "symbex-tofino2" DRIVER ${SYMBEX_DRIVER}
...
p4tools_add_tests(
  TESTS "${P4TOOLS_SYMBEX_TOFINO_TNA}"
  TAG "symbex-tofino-ptf" DRIVER ${SYMBEX_DRIVER}
...
p4tools_add_tests(
  ...
  TAG "symbex-tofino2-ptf" DRIVER ${SYMBEX_DRIVER}
...
# set_tests_properties("symbex-tofino2-ptf/switch_tofino2_y2.p4" PROPERTIES TIMEOUT 6000)
# set_tests_properties("symbex-tofino2/switch_tofino2_y2.p4" PROPERTIES TIMEOUT 6000)
# set_tests_properties("symbex-tofino2-ptf/switch_tofino2_y1_mod.p4" PROPERTIES TIMEOUT 6000)
# set_tests_properties("symbex-tofino2/switch_tofino2_y1_mod.p4" PROPERTIES TIMEOUT 6000)


# set_tests_properties("symbex-tofino-ptf/switch_tofino_x2.p4" PROPERTIES TIMEOUT 6000)
# set_tests_properties("symbex-tofino/switch_tofino_x2.p4" PROPERTIES TIMEOUT 6000)
# set_tests_properties("symbex-tofino/switch_tofino_x1_mod.p4" PROPERTIES TIMEOUT 6000)

# set_tests_properties("symbex-tofino2/tna_alpmV2.p4" PROPERTIES TIMEOUT 3000)
# set_tests_properties("symbex-tofino2/tna_ipv4_alpm.p4" PROPERTIES TIMEOUT 3000)


# # # ##########################################################################
# UNSTABLE TESTS
# # # ##########################################################################
# p4c_add_test_label("symbex-tofino2-ptf" "UNSTABLE" "switch_tofino2_y1_mod.p4")
...
# p4tools_add_to_nightly("${P4TOOLS_SYMBEX_TOFINO_TNA}" "symbex-tofino")
