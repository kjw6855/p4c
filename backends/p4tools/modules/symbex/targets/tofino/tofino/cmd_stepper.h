...
#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_TOFINO_TOFINO_CMD_STEPPER_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_TOFINO_TOFINO_CMD_STEPPER_H_
...
class TofinoCmdStepper : public CmdStepper {
 protected:
    std::string getClassName() override { return "TofinoCmdStepper"; }

    const TofinoProgramInfo &getProgramInfo() const override;
 ...
 public:
    TofinoCmdStepper(ExecutionState &state, AbstractSolver &solver, const ProgramInfo &programInfo);
};

}  // namespace P4::P4Tools::Symbex::Tofino

#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_TOFINO_TOFINO_CMD_STEPPER_H_ */
