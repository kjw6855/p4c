...
uint16_t TNAHash::crc16(const char *buf, size_t len) {
...
uint32_t TNAHash::crc32(const char *buf, size_t len) {
...
uint16_t TNAHash::crcCCITT(const char *buf, size_t len) {
...
uint16_t TNAHash::csum16(const char *buf, size_t len) {
    uint64_t sum = 0;
...
uint16_t TNAHash::xor16(const char *buf, size_t len) {
...
uint64_t TNAHash::identity(const char *buf, size_t len) {
    uint64_t res = 0ULL;
