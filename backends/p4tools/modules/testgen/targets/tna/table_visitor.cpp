...
const IR::Expression *TnaTableVisitor::computeTargetMatchType(
...
void TnaTableVisitor::evalTableActionProfile(
...
void TnaTableVisitor::evalTableActionSelector(
    const std::vector<const IR::ActionListElement *> &tableActionList) {
    const auto *state = getExecutionState();
...
bool TnaTableVisitor::checkForActionProfile() {
...
bool TnaTableVisitor::checkForActionSelector() {
    const auto *impl = table->properties->getProperty("implementation");
    if (impl == nullptr) {
        return false;
    }
...
void TnaTableVisitor::checkTargetProperties(
    const std::vector<const IR::ActionListElement *> & /*tableActionList*/) {
...
void TnaTableVisitor::evalTargetTable(
    const std::vector<const IR::ActionListElement *> &tableActionList) {
