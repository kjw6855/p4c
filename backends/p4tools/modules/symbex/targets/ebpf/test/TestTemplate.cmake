...
macro(check_with_kernel testfile testfolder p4test runner_args)
  set(__symbexbpfpath "${P4C_BINARY_DIR}/p4c-ebpf")
  ...
  file(APPEND ${__testfile} "\tpython3 ${__ebpfrunner} ${runner_args} -t kernel -c ${__symbexbpfpath} -tf \${item} ${P4C_SOURCE_DIR} ${p4test}\n")
