...
#include "backends/p4tools/modules/testgen/targets/tna/table_stepper.h"
...
std::string TnaExprStepper::getClassName() { return "TnaExprStepper"; }

bool TnaExprStepper::isPartOfFieldList(const IR::StructField *field,
...
void TnaExprStepper::resetPreservingFieldList(ExecutionState &nextState,
...
void TnaExprStepper::processClone(const ExecutionState &state,
...
void TnaExprStepper::processRecirculate(const ExecutionState &state,
                                                SmallStepEvaluator::Result &result) {
...
TnaExprStepper::TnaExprStepper(ExecutionState &state, AbstractSolver &solver,
                                               const ProgramInfo &programInfo)
    : ExprStepper(state, solver, programInfo) {}

void TnaExprStepper::evalExternMethodCall(const IR::MethodCallExpression *call,
...
bool TnaExprStepper::preorder(const IR::P4Table *table) {
    // Delegate to the tableStepper.
    TnaTableStepper tableStepper(this, table);
