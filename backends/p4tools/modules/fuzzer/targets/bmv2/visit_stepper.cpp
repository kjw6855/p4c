...
#include "backends/p4tools/modules/fuzzer/targets/bmv2/table_visitor.h"
...
std::string BMv2_V1ModelVisitStepper::getClassName() { return "BMv2_V1ModelVisitStepper"; }

bool BMv2_V1ModelVisitStepper::isPartOfFieldList(const IR::StructField* field,
...
void BMv2_V1ModelVisitStepper::resetPreservingFieldList(VisitState* nextState,
...
BMv2_V1ModelVisitStepper::BMv2_V1ModelVisitStepper(VisitState& state,
                                                 const ProgramInfo& programInfo,
                                                 const TestCase& testCase)
    : VisitStepper(state, programInfo, testCase) {}

void BMv2_V1ModelVisitStepper::evalExternMethodCall(const IR::MethodCallExpression* call,
                                                   const IR::Expression* receiver, IR::ID name,
                                                   const IR::Vector<IR::Argument>* args,
                                                   VisitState& state) {
    const VisitExternMethodImpls::MethodImpl AssertAssumeExecute =
        [](const IR::MethodCallExpression* call, const IR::Expression* /*receiver*/,
           IR::ID& methodName, const IR::Vector<IR::Argument>* args, const VisitState& state,
    ...
    static const VisitExternMethodImpls EXTERN_METHOD_IMPLS({
        /* ======================================================================================
         *  mark_to_drop
        ...
        {"*method.hash",
         ...
         [this](const IR::MethodCallExpression* call, const IR::Expression* receiver, IR::ID& name,
                const IR::Vector<IR::Argument>* args, const VisitState& state,
                VisitStepEvaluator::VisitResult& result) {
        ...
        {"*method.clone_preserving_field_list",
         ...
         [this](const IR::MethodCallExpression* call, const IR::Expression* /*receiver*/,
             ...
             if (cloneType == BMv2Constants::CLONE_TYPE_I2E) {
                 ...
                 // is.
                 {
                     auto* defaultState = new VisitState(state);
        ...
        {"*.check_recirculate",
         ...
         [this](const IR::MethodCallExpression* /*call*/, const IR::Expression* /*receiver*/,
                IR::ID& /*methodName*/, const IR::Vector<IR::Argument>* /*args*/,
                const VisitState& state, VisitStepEvaluator::VisitResult& result) {
             auto* recState = new VisitState(state);
    ...
    if (!EXTERN_METHOD_IMPLS.exec(call, receiver, name, args, state, result)) {
        VisitStepper::evalExternMethodCall(call, receiver, name, args, state);
    }
}  // NOLINT

bool BMv2_V1ModelVisitStepper::preorder(const IR::P4Table* table) {
    // Delegate to the tableVisitor.
    BMv2_V1ModelTableVisitor tableVisitor(this, table, testCase);
