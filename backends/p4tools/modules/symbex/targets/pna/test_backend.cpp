...
#include "backends/p4tools/modules/symbex/targets/pna/backend/metadata/metadata.h"
#include "backends/p4tools/modules/symbex/targets/pna/backend/ptf/ptf.h"
...
PnaTestBackend::PnaTestBackend(const ProgramInfo &programInfo,
    ...
    cstring testBackendString = SymbexOptions::get().testBackend;
...
const TestSpec *PnaTestBackend::createTestSpec(const ExecutionState *executionState,
    ...
    if (SymbexOptions::get().testBackend == "METADATA") {
