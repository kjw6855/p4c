#ifndef BACKENDS_P4TOOLS_MODULES_FUZZER_TARGETS_BMV2_VISIT_CONCOLIC_H_
#define BACKENDS_P4TOOLS_MODULES_FUZZER_TARGETS_BMV2_VISIT_CONCOLIC_H_
...
class Bmv2VisitConcolic : public VisitConcolic {
 private:
    ...
    static const VisitConcolicMethodImpls::ImplList Bmv2VisitConcolicMethodImpls;
 ...
 public:
    ...
    static const VisitConcolicMethodImpls::ImplList* getBmv2VisitConcolicMethodImpls();
};
...
#endif /* BACKENDS_P4TOOLS_MODULES_FUZZER_TARGETS_BMV2_VISIT_CONCOLIC_H_ */
