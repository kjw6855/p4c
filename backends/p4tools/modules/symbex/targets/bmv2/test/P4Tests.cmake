...
# Custom BMv2 tests.
set(SYMBEX_BMV2_P416_TESTS "${CMAKE_CURRENT_LIST_DIR}/p4-programs/*.p4")
p4c_find_tests("${SYMBEX_BMV2_P416_TESTS}" BMV2_P4_16_V1_TESTS INCLUDE "${V1_SEARCH_PATTERNS}" EXCLUDE "")

# Add BMv2 tests from p4c and from symbex/test/p4-programs/bmv2
set(P4C_V1_TEST_SUITES_P416 ${P4_16_V1_TESTS} ${BMV2_P4_16_V1_TESTS})

#############################################################################
# TEST SUITES
#############################################################################
option(P4TOOLS_SYMBEX_BMV2_TEST_METADATA "Run tests on the Metadata test back end" ON)
option(P4TOOLS_SYMBEX_BMV2_TEST_PROTOBUF "Run tests on the Protobuf test back end" OFF)
option(P4TOOLS_SYMBEX_BMV2_TEST_PROTOBUF_IR "Run tests on the Protobuf test back end" ON)
option(P4TOOLS_SYMBEX_BMV2_TEST_PTF "Run tests on the PTF test back end" ON)
option(P4TOOLS_SYMBEX_BMV2_TEST_STF "Run tests on the STF test back end" ON)
# Test settings.
...
# Protobuf
if(P4TOOLS_SYMBEX_BMV2_TEST_PROTOBUF)
  p4tools_add_tests(
    TESTS "${P4C_V1_TEST_SUITES_P416}"
    TAG "symbex-p4c-bmv2-protobuf" DRIVER ${SYMBEX_DRIVER}
...
# Protobuf IR
if(P4TOOLS_SYMBEX_BMV2_TEST_PROTOBUF_IR)
  p4tools_add_tests(
    TESTS "${P4C_V1_TEST_SUITES_P416}"
    TAG "symbex-p4c-bmv2-protobuf-ir" DRIVER ${SYMBEX_DRIVER}
...
# Metadata
if(P4TOOLS_SYMBEX_BMV2_TEST_METADATA)
  p4tools_add_tests(
    TESTS "${P4C_V1_TEST_SUITES_P416}"
    TAG "symbex-p4c-bmv2-metadata" DRIVER ${SYMBEX_DRIVER}
...
macro(add_bmv2_ptf_tests)
  if(NOT P4TOOLS_SYMBEX_BMV2_TEST_PTF)
    return()
  endif()
  ...
  p4tools_add_tests(
    ...
    TAG "symbex-p4c-bmv2-ptf" DRIVER ${SYMBEX_DRIVER}
...
macro(add_bmv2_stf_tests)
  if(NOT P4TOOLS_SYMBEX_BMV2_TEST_STF)
    return()
  endif()
  ...
  p4tools_add_tests(
    TESTS "${P4C_V1_TEST_SUITES_P416}"
    TAG "symbex-p4c-bmv2-stf" DRIVER ${SYMBEX_DRIVER}
