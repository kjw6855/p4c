#ifndef TESTGEN_TARGETS_TNA_P4_ASSERTS_PARSER_H_
#define TESTGEN_TARGETS_TNA_P4_ASSERTS_PARSER_H_
...
namespace P4Tools {
namespace TnaAssertsParser {

class TnaAssertsParser : public Transform {
    std::vector<std::vector<const IR::Expression *>> &restrictionsVec;

 public:
    explicit TnaAssertsParser(std::vector<std::vector<const IR::Expression *>> &output);
...
#endif /* TESTGEN_TARGETS_TNA_P4_ASSERTS_PARSER_H_ */
