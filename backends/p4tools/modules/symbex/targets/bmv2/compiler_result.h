#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_BMV2_COMPILER_RESULT_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_BMV2_COMPILER_RESULT_H_
...
#include "backends/p4tools/modules/symbex/targets/bmv2/map_direct_externs.h"
#include "backends/p4tools/modules/symbex/targets/bmv2/p4_asserts_parser.h"

namespace P4::P4Tools::Symbex::Bmv2 {

/// Extends the CompilerResult with information specific to the V1Model running on BMv2.
class BMv2V1ModelCompilerResult : public SymbexCompilerResult {
 private:
 ...
 public:
    explicit BMv2V1ModelCompilerResult(SymbexCompilerResult compilerResult,
                                       P4::P4RuntimeAPI p4runtimeApi,
                                       DirectExternMap directExternMap,
                                       ConstraintsVector p4ConstraintsRestrictions);
    ...
    DECLARE_TYPEINFO(BMv2V1ModelCompilerResult, SymbexCompilerResult);
};

}  // namespace P4::P4Tools::Symbex::Bmv2

#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_BMV2_COMPILER_RESULT_H_ */
