...
SymbexOptions &SymbexOptions::get() { return CompileContext<SymbexOptions>::get().options(); }

const std::set<cstring> SymbexOptions::SUPPORTED_STOP_METRICS = {"MAX_NODE_COVERAGE"_cs};

SymbexOptions::SymbexOptions()
    ...
    registerOption(
        ...
        "Specify the set of control plane entities for which Symbex should not generate a "
        "configuration for. For example, if a particular table is in the set, Symbex will "
    ...
    registerOption(
        ...
        "Select the test back end. Symbex will produce tests that correspond to the input "
    ...
    registerOption(
        ...
        [this](const char *arg) {
            ...
            static std::map<cstring, PathSelectionPolicy> const PATH_SELECTION_OPTIONS = {
                ...
                {"STATE_DEP_TAMPERING_COND"_cs, PathSelectionPolicy::StateDependencyTamperingCond},
        ...
        "STATE_DEP_TAMPERING, STATE_DEP_TAMPERING_COND, STATE_DEP_ALTERING_PATH. "
    ...
    registerOption(
        ...
        "Do not apply the conditions defined within \"symbex_assume\" extern calls in P4 programs."
        "They will have no effect on Symbex's path exploration.");
