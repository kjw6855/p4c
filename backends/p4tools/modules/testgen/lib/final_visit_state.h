#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_FINAL_VISIT_STATE_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_FINAL_VISIT_STATE_H_
...
class FinalVisitState {
 ...
 public:
    ...
    [[nodiscard]] std::optional<std::reference_wrapper<const FinalVisitState>> computeConcolicState(
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_FINAL_VISIT_STATE_H_ */
