...
ProgramInfo::ProgramInfo(const SymbexCompilerResult &compilerResult)
...
const SymbexCompilerResult &ProgramInfo::getCompilerResult() const { return compilerResult.get(); }
