#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_CORE_PROGRAM_INFO_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_CORE_PROGRAM_INFO_H_
...
class ProgramInfo : public ICastable {
 private:
    ...
    std::reference_wrapper<const SymbexCompilerResult> compilerResult;

 protected:
    explicit ProgramInfo(const SymbexCompilerResult &compilerResult);
 ...
 public:
    ...
    /// with.
    [[nodiscard]] virtual const SymbexCompilerResult &getCompilerResult() const;
...
#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_CORE_PROGRAM_INFO_H_ */
