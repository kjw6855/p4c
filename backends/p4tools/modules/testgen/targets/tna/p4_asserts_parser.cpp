...
namespace P4Tools::TnaAssertsParser {
...
TnaAssertsParser::TnaAssertsParser(std::vector<std::vector<const IR::Expression *>> &output)
...
std::vector<const IR::Expression *> TnaAssertsParser::genIRStructs(
...
const IR::Node *TnaAssertsParser::postorder(IR::P4Table *node) {
