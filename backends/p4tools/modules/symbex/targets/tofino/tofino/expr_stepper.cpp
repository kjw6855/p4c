...
Tofino1ExprStepper::Tofino1ExprStepper(ExecutionState &state, AbstractSolver &solver,
                                       const ProgramInfo &programInfo)
    : SharedTofinoExprStepper(state, solver, programInfo) {}

// Provides implementations of JBay externs.
const Tofino1ExprStepper::ExternMethodImpls<Tofino1ExprStepper>
    Tofino1ExprStepper::TOFINO_EXTERN_METHOD_IMPLS({});

void Tofino1ExprStepper::evalExternMethodCall(const ExternInfo &externInfo) {
    auto method = TOFINO_EXTERN_METHOD_IMPLS.find(externInfo.externObjectRef, externInfo.methodName,
