#include "backends/p4tools/modules/testgen/targets/bmv2/cmd_parse_getter.h"
...
Bmv2V1ModelCmdParseGetter::Bmv2V1ModelCmdParseGetter(ExecutionState &state,
                                             const ProgramInfo &programInfo)
    : CmdParseGetter(state, programInfo) {}

const Bmv2V1ModelProgramInfo &Bmv2V1ModelCmdParseGetter::getProgramInfo() const {
    return *CmdParseGetter::getProgramInfo().checkedTo<Bmv2V1ModelProgramInfo>();
}

void Bmv2V1ModelCmdParseGetter::initializeTargetEnvironment(ExecutionState &nextState) const {
...
std::optional<const Constraint *> Bmv2V1ModelCmdParseGetter::startParserImpl(
...
std::map<Continuation::Exception, Continuation> Bmv2V1ModelCmdParseGetter::getExceptionHandlers(
