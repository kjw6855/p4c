#ifndef BACKENDS_P4TOOLS_MODULES_FUZZER_LIB_VISIT_STATE_H_
#define BACKENDS_P4TOOLS_MODULES_FUZZER_LIB_VISIT_STATE_H_
...
class VisitState {
 ...
 public:
    ...
    static const IR::Member* getInputPacketVar();

    static const IR::Member* getPacketBufferVar();
 ...
 public:
    ...
    explicit VisitState(const IR::P4Program* program);

 private:
    /// Create an initial execution state with @param body for testing.
    explicit VisitState(Continuation::Body body);
};
...
#endif /* BACKENDS_P4TOOLS_MODULES_FUZZER_LIB_VISIT_STATE_H_ */
