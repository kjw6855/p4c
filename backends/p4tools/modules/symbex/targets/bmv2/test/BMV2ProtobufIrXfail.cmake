...
# ================================================
# Xfails are _temporary_ failures: the tests should work but we haven't fixed symbex yet.
...
# 2. Symbex Issues
####################################################################################################
# These are failures in Symbex that need to be fixed.
...
# 3. WONTFIX
####################################################################################################
# These are failures that can not be solved by changing Symbex
...
p4tools_add_xfail_reason(
  "symbex-p4c-bmv2-protobuf-ir"
  "Symbex back end only supports a 'V1Switch' main"
