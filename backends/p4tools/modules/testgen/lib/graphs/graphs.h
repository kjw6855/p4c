...
#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_GRAPHS_GRAPHS_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_GRAPHS_GRAPHS_H_
...
class Graphs : public Inspector {
 public:
    ...
    using edgeProperties = boost::property<
        ...
        boost::property<boost::edge_name_t, cstring,
            boost::property<boost::edge_index_t, int,
                boost::property<boost::edge_weight_t, big_int>>>>;
    ...
    using AdjacencyIterator = boost::graph_traits<Graph_>::adjacency_iterator;
    using VertexIterator = boost::graph_traits<Graph_>::vertex_iterator;
    using OutEdgeIterator = boost::graph_traits<Graph_>::out_edge_iterator;
    ...
    void calc_ball_larus();

    vertex_t add_vertex(const cstring &name, const IR::Node *node, VertexType type);
    vertex_t add_and_connect_vertex(const cstring &name, const IR::Node *node, VertexType type);
...
#endif  // BACKENDS_P4TOOLS_MODULES_TESTGEN_LIB_GRAPHS_GRAPHS_H_
