...
# TEST SUITES
# ##################################################################################################
option(P4TOOLS_SYMBEX_EBPF_TEST_STF "Run tests on the STF test back end" ON)
# Test settings.
set(EXTRA_OPTS "--strict --print-traces --seed 1000 --max-tests 10")

if(P4TOOLS_SYMBEX_EBPF_TEST_STF)
  p4tools_add_tests(
    TESTS
  ...
  # "${P4C_SOURCE_DIR}/p4_16_samples/ebpf_checksum_extern.p4;" TAG "symbex-p4c-ebpf" DRIVER
  # ${SYMBEX_DRIVER} TARGET "ebpf" ARCH "ebpf" ENABLE_RUNNER RUNNER_ARGS "--extern-file
