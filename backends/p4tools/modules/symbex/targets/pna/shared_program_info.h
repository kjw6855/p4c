#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_PNA_SHARED_PROGRAM_INFO_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_PNA_SHARED_PROGRAM_INFO_H_
...
class SharedPnaProgramInfo : public ProgramInfo {
 ...
 public:
    SharedPnaProgramInfo(const SymbexCompilerResult &compilerResult,
...
#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_TARGETS_PNA_SHARED_PROGRAM_INFO_H_ */
