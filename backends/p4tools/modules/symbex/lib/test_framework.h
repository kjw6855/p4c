#ifndef BACKENDS_P4TOOLS_MODULES_SYMBEX_LIB_TEST_FRAMEWORK_H_
#define BACKENDS_P4TOOLS_MODULES_SYMBEX_LIB_TEST_FRAMEWORK_H_
...
std::vector<const ConcreteTest *> convertAbstractTestsToConcreteTests(
    const P4::P4Tools::Symbex::AbstractTestList &testList) {
...
class TestFramework {
 ...
 public:
    ...
    virtual AbstractTestReferenceOrError produceTest(const TestSpec *spec, cstring selectedBranches,
                                                     size_t testIdx, float currentCoverage,
                                                     unsigned char* testCoverage, int mapSize);
...
#endif /* BACKENDS_P4TOOLS_MODULES_SYMBEX_LIB_TEST_FRAMEWORK_H_ */
