#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_PARSE_GET_CMD_PARSE_GETTER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_PARSE_GET_CMD_PARSE_GETTER_H_
...
/// Implements small-parse_get operational semantics for commands.
class CmdParseGetter : public AbstractParseGetter {
 public:
    CmdParseGetter(ExecutionState &state, const ProgramInfo &programInfo);
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_PARSE_GET_CMD_PARSE_GETTER_H_ */
