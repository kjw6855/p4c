#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_VISIT_ABSTRACT_VISITOR_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_VISIT_ABSTRACT_VISITOR_H_
...
class AbstractVisitor : public Inspector {
 public:
 ...
 protected:
    ...
    /// Helper function for debugging execution of small visitor.
    ...
    /// @see stepToListSubexpr.IR::StructExpression differs slightly from IR::BaseListExpression in that
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_SMALL_VISIT_ABSTRACT_VISITOR_H_ */
